...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('tenant_schema_name', type=str, help='Schema name of the tenant')
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stderr.write(self.style.ERROR(f'Tenant with schema name "{tenant_schema_name}" does not exist'))
        else:
            self.stdout.write(
                self.style.SUCCESS(
