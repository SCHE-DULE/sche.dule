    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=255,
                        null=None,
                        verbose_name="Nome conforme documento",
                    ),
                ),
                ...
                (
                    "phone_number",
                    models.CharField(max_length=20, verbose_name="Celular"),
                ),
                (
                    "gender",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=50, verbose_name="Speciality Name"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=14,
                        unique=True,
                        verbose_name="CPF com validação de dígitos",
                    ),
                ),
                (
                    "rg_or_rne",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=20,
                        verbose_name="Cadastro do Órgão de Registro (ex: CRM)",
                    ),
                ),
                (
                    "rate",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Valor Cobrado"
                    ),
                ),
                (
                    "fee",
                ...
                (
                    "specialities",
                    models.ManyToManyField(
                        to="accounts.speciality", verbose_name="Especialidades"
                    ),
                ),
            ],
            options={
